...
mixin _$ExchangeRatesState {
  List<ExchangeRatesModel> get results => throw _privateConstructorUsedError;
...
abstract class $ExchangeRatesStateCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<ExchangeRatesModel> results, Status status, String? errorMessage});
}
...
class _$_ExchangeRatesState implements _ExchangeRatesState {
  _$_ExchangeRatesState(
      {final List<ExchangeRatesModel> results = const [],
      this.status = Status.initial,
      this.errorMessage})
      : _results = results;

  final List<ExchangeRatesModel> _results;
  @override
  @JsonKey()
  List<ExchangeRatesModel> get results {
  ...
  @override
  String toString() {
    return 'ExchangeRatesState(results: $results, status: $status, errorMessage: $errorMessage)';
  }
...
abstract class _ExchangeRatesState implements ExchangeRatesState {
  factory _ExchangeRatesState(
      ...
      final Status status,
      final String? errorMessage}) = _$_ExchangeRatesState;
